...
namespace BiometricCore
{
    public class ZKTekoBiometric
    {
        ...
        /// <summary>
        /// Obtiene todos los logs de los regisros de asistencias
        /// </summary>
        ...
        public bool ReadGLogDataByDate(int dwMachineNumber, string startDate, string endDate)
        {
            return objCZKEM.ReadTimeGLogData(dwMachineNumber, startDate, endDate);
        }
        ...
        {
            return objCZKEM.GetSysOption(dwMachineNumber, Option, out Value);
        }
